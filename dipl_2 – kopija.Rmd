...
repeats_plot_20
ggsave(repeats_plot_20,file="repeats_plot_20.png")
...
ggsave(fpkm_prot_lncrna_plot,file="fpkm_prot_lncrna_plot.png")
...
ggsave(fpkm_groups_all_lncrna_plot,file="fpkm_groups_all_lncrna_plot.png",width=6,height = 5)
#expression boxplots
...
pval_dist_plot
ggsave(pval_dist_plot,file="pval_dist_plot.png",width=6,height = 5)
...
class_pval_plot<-ggplot(randfold_together_one_merged,aes(x=class,y=p_value,fill=class)) +
  ...
  ggsave(class_pval_plot,file="class_pval_plot.png",width = 6,height = 5)
