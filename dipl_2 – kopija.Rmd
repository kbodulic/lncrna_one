...
library(Gviz)
setwd("C:/Users/krist/Desktop/1_script")
...
overlaps_repeats_lncrna_bases_table<-overlaps_repeats_lncrna_bases_table[inter_width_vector>=20]
...
trans_ex_within<-findOverlaps(repeatmasker_esu_granges,lncrna_filtered_exons_clean_dt_gr_split_red_un,ignore.strand=T,type="within")
trans_ex_within_dt<-cbind(as.data.table(repeatmasker_esu_granges[queryHits(trans_ex_within)]),as.data.table(lncrna_filtered_exons_clean_dt_gr_split_red_un_dt[subjectHits(trans_ex_within)]))
setnames(trans_ex_within_dt,c("seqnames1","start1","end1","width1","strand1","SW_score","perc.sub","perc.del","perc.ins","base_past_end","strand_ignore","repeat_name","repeat_start","repeat_end","repeat_left_bases","ID","V16","repeat_class","repeat_family","species","size","library","group","ltrret_ID","type","elementtype","rep_width","rep_gen_width","genperc","seqnames2","start2","end2","width2","strand2","transcript","gene_id"))
trans_ex_within_dt[,gene_trans_paste:=paste(ID,seqnames2,start2,end2,sep="_")]


trans_within_ex<-unique(trans_ex_within_dt$gene_trans_paste)

ex_trans_within<-findOverlaps(lncrna_filtered_exons_clean_dt_gr_split_red_un,repeatmasker_esu_granges,ignore.strand=T,type="within")
ex_trans_within_dt<-cbind(as.data.table(lncrna_filtered_exons_clean_dt_gr_split_red_un[queryHits(ex_trans_within)]),as.data.table(repeatmasker_esu_granges[subjectHits(ex_trans_within)]))
setnames(ex_trans_within_dt,c("seqnames1","start1","end1","width1","strand1","transcript","gene_id","seqnames2","start2","end2","width2","strand2","SW_score","perc_sub","perc_del","perc_ins","base_past_end","strand_ignore","repeat_name","repeat_start","repeat_end","repeat_left_bases","ID","V16","repeat_class","repeat_family","species","size","library","group","ltrretID","type","elementtype","rep_width","rep_gen_width","genperc"))
ex_trans_within_dt[,gene_trans_paste:=paste(ID,seqnames1,start1,end1,sep="_")]

ex_within_trans<-unique(ex_trans_within_dt$gene_trans_paste)

overlaps_repeats_exons_table_20[,gene_trans_paste:=paste(ID,seqnames2,start2,end2,sep="_")]

splice_sites_trans<-overlaps_repeats_exons_table_20[gene_trans_paste%in%c(trans_within_ex,ex_within_trans)==F]$gene_trans_paste

length(trans_within_ex)
length(ex_within_trans)
length(splice_sites_trans)
total_trans_ex<-length(trans_within_ex)+length(ex_within_trans)+length(splice_sites_trans)
length(trans_within_ex)/total_trans_ex
length(ex_within_trans)/total_trans_ex
length(splice_sites_trans)/total_trans_ex
...
overlaps_repeats_proteins_bases_table<-overlaps_repeats_proteins_bases_table[inter_width_vector>=20]
...
trans_ex_within_prot<-findOverlaps(repeatmasker_esu_granges,protein_exons_new,ignore.strand=T,type="within")
trans_ex_within_prot_dt<-cbind(as.data.table(repeatmasker_esu_granges[queryHits(trans_ex_within_prot)]),as.data.table(protein_exons_new[subjectHits(trans_ex_within_prot)]))
setnames(trans_ex_within_prot_dt,c("seqnames1","start1","end1","width1","strand1","SW_score","perc.sub","perc.del","perc.ins","base_past_end","strand_ignore","repeat_name","repeat_start","repeat_end","repeat_left_bases","ID","V16","repeat_class","repeat_family","species","size","library","group","ltrret_ID","type","elementtype","rep_width","rep_gen_width","genperc","seqnames2","start2","end2","width2","strand2","attribute"))
trans_ex_within_prot_dt[,gene_trans_paste:=paste(ID,seqnames2,start2,end2,sep="_")]


trans_within_ex_prot<-unique(trans_ex_within_prot_dt$gene_trans_paste)

ex_trans_within_prot<-findOverlaps(protein_exons_new,repeatmasker_esu_granges,ignore.strand=T,type="within")
ex_trans_within_prot_dt<-cbind(as.data.table(protein_exons_new[queryHits(ex_trans_within_prot)]),as.data.table(repeatmasker_esu_granges[subjectHits(ex_trans_within_prot)]))
setnames(ex_trans_within_prot_dt,c("seqnames1","start1","end1","width1","strand1","attribute","seqnames2","start2","end2","width2","strand2","SW_score","perc_sub","perc_del","perc_ins","base_past_end","strand_ignore","repeat_name","repeat_start","repeat_end","repeat_left_bases","ID","V16","repeat_class","repeat_family","species","size","library","group","ltrretUD","type","elementtype","rep_width","rep_gen_width","genperc"))
ex_trans_within_prot_dt[,gene_trans_paste:=paste(ID,seqnames1,start1,end1,sep="_")]

ex_within_trans_prot<-unique(ex_trans_within_prot_dt$gene_trans_paste)

overlaps_repeats_protein_exons_table_20_prot[,gene_trans_paste:=paste(ID,seqnames2,start2,end2,sep="_")]

splice_sites_trans_prot<-overlaps_repeats_protein_exons_table_20_prot[gene_trans_paste%in%c(trans_within_ex,ex_within_trans)==F]$gene_trans_paste

length(trans_within_ex_prot)
length(ex_within_trans_prot)
length(splice_sites_trans_prot)
total_trans_ex_prot<-length(trans_within_ex_prot)+length(ex_within_trans_prot)+length(splice_sites_trans_prot)
length(trans_within_ex_prot)/total_trans_ex_prot
length(ex_within_trans_prot)/total_trans_ex_prot
length(splice_sites_trans_prot)/total_trans_ex_prot
...
total_lengths_dt<-data.table(class=c(rep("overlapping_lncRNA",3),rep("intronic_lncRNA",3),rep("intergenic_lncRNA",3),rep("protein_coding_genes",3)),category=rep(c("exon","intron","proximity"),4),total_sum_inside=c(overlapping_exons_sum,overlapping_introns_sum,overlapping_regions_sum,intronic_exons_sum,intronic_introns_sum,intronic_regions_sum,intergenic_exons_sum,intergenic_introns_sum,intergenic_regions_sum,protein_exons_sum,protein_introns_sum,protein_regions_sum))
...
ggsave(repeats_plot_normalized_sum_bases_20,file="2repeats_plot_normalized_sum_bases_20.png",width=7,height = 6)
...
overlaps_repeat_together_num_table_normalized_sum_bases_20_2[class=="overlapping_lncRNA" & category=="proximity",number_of_bases:=number_of_bases/overlapping_regions_sum]
...
overlaps_repeat_together_num_table_normalized_sum_bases_20_2[class=="intronic_lncRNA" & category=="proximity",number_of_bases:=number_of_bases/intronic_regions_sum]
...
overlaps_repeat_together_num_table_normalized_sum_bases_20_2[class=="intergenic_lncRNA" & category=="proximity",number_of_bases:=number_of_bases/intergenic_regions_sum]
...
overlaps_repeat_together_num_table_normalized_sum_bases_20_2[class=="protein_coding_genes" & category=="proximity",number_of_bases:=number_of_bases/protein_regions_sum]
...
ggsave(repeats_plot_normalized_sum_bases_20_2,file="2repeats_plot_normalized_sum_bases_20_2.png",width=7.6,height = 3.5)
...
lncrnas_final_reduced_together_20kb<-lncrnas_final_reduced_together[start(lncrnas_final_reduced_together)>2500]
lncrnas_final_reduced_together_20kb_short<-lncrnas_final_reduced_together[start(lncrnas_final_reduced_together)<=2500]
...
new_starts<-start(lncrnas_final_reduced_together_20kb)-2500
...
lncrnas_final_reduced_together_20kb_right<-lncrnas_final_reduced_together[end(lncrnas_final_reduced_together)<(lncrnas_final_reduced_together_dt_cont_length_merge$cont_length-2500)]
lncrnas_final_reduced_together_20kb_short_right<-lncrnas_final_reduced_together[end(lncrnas_final_reduced_together)>(lncrnas_final_reduced_together_dt_cont_length_merge$cont_length-2500)]
...
end(lncrnas_final_reduced_together_20kb_right)<-end(lncrnas_final_reduced_together_20kb_right)+2500
...
setwd("C:/Users/krist/Desktop/1_script/22")
...
integration_names<-unique(prot_overlaps_20kb_dt_GO_longer_p_merged[GO_term=="DNA integration"]$attribute)

integration_names<-paste(integration_names,"t1",sep=".")
write.table(integration_names,file = "integration_names.txt",sep = "\t",quote = F,row.names = F,col.names = F)
...
prot_overlaps_20kb_dt[(start1<start2 & strand_ignore =="+") | (start1>start2 & strand_ignore  =="-"),prom:=T]

prot_overlaps_20kb_dt_prom<-prot_overlaps_20kb_dt[prom==T]
prot_overlaps_20kb_dt_prom_class<-merge(prot_overlaps_20kb_dt_prom,lncRNA_classification_table_with_gene_id[,.SD,.SDcols=c("gene_id","class")],by="gene_id")
prot_overlaps_20kb_dt_prom_class_inter<-prot_overlaps_20kb_dt_prom_class[class=="intergenic_lncRNA"]

motif_gff<-read.table("zinc_motif.txt",fill=T)
motif_gff<-as.data.table(motif_gff)



trans_motif<-unique(motif_gff$V1)

trans_motif_gene_ids<-unique(isoform_map_table_together[transcript_name%in%trans_motif]$gene_id)


trans_motif_gene_ids_prom<-trans_motif_gene_ids[trans_motif_gene_ids%in%prot_overlaps_20kb_dt_prom_class_inter$gene_id]

trans_motif_gene_ids_prom
```


```{r}
#uvod reference osvjeziti
#kako formirati rezultate - sto uzeti
