...
perc_within_trans<-ggplot(data=overlaps_repeat_together_num_table,aes(x=class,y=percentage_genes_within))
...
num_f_cons<-ggplot(data=prot_overlaps_20kb_dt_GO_longer_f_merged_N,aes(x=GO_term,y=N,fill=cons_cat)) +
...
prot_overlaps_20kb_dt_GO_longer_f_merged_class_N[,GO_term:=factor(GO_term,levels = top_go_f)]

prot_overlaps_20kb_dt_GO_longer_p_merged_class_N<-prot_overlaps_20kb_dt_GO_longer_p_merged_class_N[GO_term%in%top_go_p]
prot_overlaps_20kb_dt_GO_longer_p_merged_class_N[,GO_term:=factor(GO_term,levels = top_go_p)]
...
ggsave(num_p_cons_class,filename = "num_p_cons_class.png",height = 8,width = 10)
```
...
ggplot(data=prot_overlaps_20kb_dt_GO_longer_p_merged2_exp,aes(x=GO_term,y=FPKM,fill=GO_term)) +
  geom_boxplot() +
  theme_bw() +
  theme(legend.position = "none") +
  scale_y_log10() +
