...
perc_plot<-ggplot(data=overlap_table,aes(x=length_frac))+
  geom_histogram(fill="chocolate1",col="black",binwidth = 5,alpha=0.85) +
  theme_bw() +
...
lncrna_numbers_table_plot[,category:=factor(category,levels = c("All genes","Unique genes","Longer genes (>= 20% overlap)","Shorter genes (>= 20% overlap)","Longer genes (< 20% overlap)","Shorter genes (< 20% overlap)","Final genes"))]
