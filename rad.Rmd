...
figure_seven<-ggdraw() +
  draw_plot(num_f_cons, x = 0.01, y = 0.48, width = .2, height = .4) +
  draw_plot(num_p_cons, x = .2, y = 0.48, width = .26, height = .4) +
  draw_plot(go_expression_plot, x = 0, y = 0.05, width = 0.42, height = 0.4) +
  draw_plot(num_p_cons_class, x = 0.48, y = 0.15, width = 0.5, height = 0.6) +
  draw_plot_label(label = c("A", "B", "D","C"), size =7,
                  x = c(0.01, 0.24, 0.05,0.5), y = c(0.89, 0.89, 0.47,0.76))
