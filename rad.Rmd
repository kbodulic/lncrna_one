...
library(wesanderson)
setwd("C:/Users/kbodulic/Desktop/rad")
...
figure_one<-ggdraw() +
  ...
  draw_plot_label(label = c("A", "B", "C"), size = 7,
                  x = c(0.05, 0.55, 0.55), y = c(0.8, 0.8, 0.5))
...
figure_three<-ggdraw() +
  draw_plot(number_of_lncrna_classes_plot, x = 0.162, y = 0.47, width = .27, height = .36) +
  draw_plot(class_genes_table_sum_width_plot, x = 0.45, y = 0.47, width = .27, height = .36) +
  draw_plot(class_lengths_plot, x = 0.13, y = 0.03, width = 0.6, height = 0.45) +
  draw_plot_label(label = c("A", "B", "C"), size = 7,
                  x = c(0.15, 0.45, 0.15), y = c(0.85, 0.85, 0.5))
...
figure_four<-ggdraw() +
  ...
  draw_plot_label(label = c("A", "B", "C","D"), size = 7,
                  x = c(0.035, 0.27, 0.05,0.5), y = c(0.88, 0.88, 0.47,0.83))


figure_four

ggsave(figure_four,filename = "figure_four2.tiff",height = 13,width = 16.99,units = "cm",dpi = 320)
...
figure_five<-ggdraw() +
  ...
  draw_plot(blast_heatmap_plot, x = .4, y = 0.35, width = .5, height = .62) +
  draw_plot_label(label = c("A", "B","C"), size = 7,
...
ggsave(figure_five,filename = "figure_five.tiff",height = 12,width = 16.99,units  ="cm",dpi=320)
...
setwd("C:/Users/kbodulic/Desktop/rad/synt2")
...
prot_overlaps_20kb_dt_GO_longer_p_merged_class_N[class=="intronic_lncRNA",class:="Intronic lncRNsA"]
...
figure_seven<-ggdraw() +
  draw_plot(num_f_cons, x = 0.01, y = 0.48, width = .24, height = .45) +
  draw_plot(num_p_cons, x = .25, y = 0.48, width = .26, height = .45) +
  draw_plot(fpkm_prot_plot_flip, x = 0.1, y = 0.05, width = 0.35, height = 0.4) +
  draw_plot(num_p_cons_class, x = 0.52, y = 0.48, width = 0.47, height = 0.45) +
  draw_plot(go_expression_plot,x=0.5,y=0.05,width=0.42,height = 0.4) +
  draw_plot_label(label = c("A", "B", "D","C","E"), size =7,
                  x = c(0.01, 0.24, 0.05,0.5,0.05), y = c(0.89, 0.89, 0.47,0.76,0.47))
